  ...
  return (
    <SectionIndex
      ...
      versions={[
        ...
        { slug: "v4", title: "Hero v4", desc: "Live Canvas 2D topology network as background. 35 tier-colored nodes, mouse proximity glow, scroll parallax. The product IS the hero.", path: "/sandbox/hero/v4", current: true },
      ]}
    />
  );
}
