...
const sections = [
  {
    ...
    title: "Hero",
    versions: 3,
    desc: "The first thing you see. Live topology canvas, stats, CTA. The product IS the background.",
  },
  {
    slug: "before-after",
    title: "Before / After",
    versions: 1,
    desc: "Split-screen terminal: agent without MidOS (chaos, 12K tokens) vs with MidOS (calm, 847 tokens).",
  },
  {
    slug: "pipeline",
    title: "Pipeline",
    versions: 2,
    desc: "5-layer knowledge visualization — staging, chunks, truth, EUREKA, SOTA. Gradient particles.",
  },
  {
    slug: "orchestrator",
    title: "Orchestrator",
    versions: 3,
    desc: "The chameleon octopus. 8 capabilities, color-shifting hub, tentacle sway. Hub adopts color on hover.",
  },
  {
    slug: "topology",
    title: "Topology",
    versions: 2,
    desc: "Constellation map. Tier-colored nodes, knowledge transfer pulses, mouse proximity glow.",
  },
  {
    slug: "colony",
    title: "Colony",
  ...
  },
  {
    ...
    title: "Tier Demo",
    versions: 1,
    desc: "Same query, different depth. Dev ($0) vs Pro ($20/mo) — typewriter terminal comparison.",
  },
  {
    slug: "pricing",
    title: "Pricing",
    versions: 1,
    desc: "Two tiers: Dev ($0/forever) and Pro ($20/mo). Feature comparison, FAQ, market positioning.",
  },
  {
    slug: "horizon",
    title: "Horizon",
    versions: 2,
    desc: "Closing CTA. Hybrid aurora — CSS anchor layers + canvas wisps for organic motion.",
  },
  {
    slug: "graph",
    title: "Graph Viewer",
