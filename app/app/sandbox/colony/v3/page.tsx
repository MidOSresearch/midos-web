...
const values = [
  ...
  { title: "Evolving", desc: "Every cycle refines patterns, sharpening what works", color: "text-violet-400", borderColor: "hover:border-violet-500/30", shadow: "hover:shadow-[0_8px_30px_rgba(167,139,250,0.10)]" },
];
